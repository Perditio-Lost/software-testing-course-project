...
public class TestPaperController {
    ...
    @GetMapping("/analysis")
    public Result analysis(@RequestParam Integer testPaperId, @RequestParam Integer testId) {
        TestPaper testPaper = testPaperService.analysis(testPaperId, testId);
        return Result.success(testPaper);
    }
    ...
    public Result getDifficulty(@PathVariable Integer id) {
        TestPaper testPaper = testPaperService.selectById(id);
        Double difficulty = testPaper != null ? testPaper.getLevel() : null;
